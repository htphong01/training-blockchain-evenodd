...
import type { CashManager, CashManagerInterface } from '../../contracts/CashManager';
...
type CashManagerConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: CashManagerConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
    xs.length > 1;
...
export class CashManager__factory extends ContractFactory {
    ...
    override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<CashManager> {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): CashManager {
